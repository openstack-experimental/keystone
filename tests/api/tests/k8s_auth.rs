...
use test_api::k8s_auth::instance::create_auth_instance;
use test_api::k8s_auth::role::create_auth_role;
use test_api::resource::project::create_project;
use test_api::role::list_roles;
use test_api::token_restriction::create_token_restriction;
...
async fn test_k8s_auth() -> Result<()> {
    ...
    let (token_data, _token_secret) = k8s_auth(&test_client, &instance.id, auth_data).await?;
    //
