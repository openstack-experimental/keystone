...
register a realm and grant it access, see the
[Administrator Guide](../../../admin/features/scim/index.md).
...
(see [API-Key Authentication](api-keys.md)) — never a Fernet token. The key
...
[Realm Activation Gate](../../../admin/features/scim/index.md#realm-activation-gate)).
...
(`404`) immediately. See
[Deprovisioning & retention](../../../admin/features/scim/index.md#deprovisioning--retention)
for the
