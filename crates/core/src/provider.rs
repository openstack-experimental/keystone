...
cfg_if::cfg_if! {
    if #[cfg(any(test, feature = "mock"))] {
        ...
        /// Global Mock based provider manager.
        ...
        pub struct Provider {
            ...
            application_credential: MockApplicationCredentialProvider,
            /// Assignment provider.
            assignment: MockAssignmentProvider,
            /// Catalog provider.
            ...
            identity_mapping: MockIdentityMappingProvider,
            /// K8s auth provider.
            k8s_auth: MockK8sAuthProvider,
            /// Resource provider.
            resource: MockResourceProvider,
            /// Revoke provider.
            revoke: MockRevokeProvider,
            /// Role provider.
...
impl Provider {
    pub fn new(_cfg: Config, _plugin_manager: PluginManager) -> Result<Self, KeystoneError> {
        todo!()
    }
