...
use crate::api::v3::project::types::ProjectResponse;
...
#[utoipa::path(
    post,
    path = "/",
    operation_id = "/v4/project:create",
...
#[tracing::instrument(name = "api::v4::project_create", level = "debug", skip(state))]
...
mod tests {
    ...
    use crate::api::v3::project::types::ProjectResponse;
    use crate::api::v4::project::types::{ProjectCreateBuilder, ProjectCreateRequest};
