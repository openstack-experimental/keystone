...
pub async fn delete<S: AsRef<str>>(
    ...
    KubernetesAuthInstance::delete_by_id(id.as_ref())
        .exec(db)
        .await
        .context("deleting k8s auth instance")?;
    Ok(())
}
    ...
    async fn test_delete() {
        ...
        assert_eq!(
            ...
            [Transaction::from_sql_and_values(
                ...
                r#"DELETE FROM "kubernetes_auth_instance" WHERE "kubernetes_auth_instance"."id" = $1"#,
                ["id".into()]
            ),]
        );
    }
