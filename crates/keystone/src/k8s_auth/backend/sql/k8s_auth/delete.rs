...
pub async fn delete<S: AsRef<str>>(
    ...
    KubernetesAuth::delete_by_id(id.as_ref())
        .exec(db)
        .await
        .context("deleting k8s auth configuration")?;
    Ok(())
}
    ...
    async fn test_delete() {
        ...
        assert_eq!(
            ...
            [Transaction::from_sql_and_values(
                ...
                r#"DELETE FROM "kubernetes_auth" WHERE "kubernetes_auth"."id" = $1"#,
                ["id".into()]
            ),]
        );
    }
