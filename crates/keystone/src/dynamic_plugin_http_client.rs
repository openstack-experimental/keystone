...
//! dynamic_plugin` still re-resolves and re-validates the IP on *every*
...
use openstack_keystone_core::dynamic_plugin_http::{DynamicPluginHttpFetcher, FetchResponse};
