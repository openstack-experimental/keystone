...
## [0.1.1](https://github.com/openstack-experimental/keystone/compare/openstack-keystone-distributed-storage-v0.1.0...openstack-keystone-distributed-storage-v0.1.1) - 2026-09-21
...
- *(raft)* Close DEK re-encrypt lost-update race ([#1336](https://github.com/openstack-experimental/keystone/pull/1336))
- *(raft)* Fix emergency DEK rotation data loss ([#1334](https://github.com/openstack-experimental/keystone/pull/1334))
- *(raft)* Guard snapshot against concurrent changes ([#1333](https://github.com/openstack-experimental/keystone/pull/1333))
...
- *(storage)* Fix flaky test_join_adopts_cluster_dek ([#1335](https://github.com/openstack-experimental/keystone/pull/1335))
